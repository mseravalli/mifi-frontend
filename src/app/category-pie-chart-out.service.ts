...
export class CategoryPieChartOutService {
  private url = 'http://localhost:9000/api/v0.1/categories/out';

  constructor(private http: Http) { }

  getCategoryPieChartOut(range: String, startDate: Date, endDate: Date, categories: Array<Category>): Promise<Array<any>> {
