...
export class SubCategoryPieChartOutService {
  private url = Utils.baseUrl + '/subcategories/out';

  constructor(private http: Http) { }

  getSubCategoryPieChartOut(range: String, startDate: Date, endDate: Date, categories: Array<Category>, subcategories: Array<SubCategory>): Promise<Array<any>> {
