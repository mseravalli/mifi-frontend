...
export class SubCategoryPieChartInService {
  private url = Utils.baseUrl + '/subcategories/in';

  constructor(private http: Http) { }

  getSubCategoryPieChartIn(range: String, startDate: Date, endDate: Date, categories: Array<Category>, subcategories: Array<SubCategory>): Promise<Array<any>> {
